...
forvalues j = 1/11 {
	...
	qui reg logw`j' everelig`j' ib1.educ perminc if age==$ageeval
	matrix b = e(b)'
	matrix V = e(V)
...
matrix colnames tab = age pi0 cost itt se
matrix list tab

global fmt f(%9.4g)
outtable using tables/table4, mat(tab) replace center norow nobox $fmt 
